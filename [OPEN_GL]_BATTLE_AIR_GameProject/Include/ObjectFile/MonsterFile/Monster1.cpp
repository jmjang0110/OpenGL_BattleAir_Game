...
std::vector< glm::vec3 > CMonster1::m_outvertex;
std::vector< glm::vec3 > CMonster1::m_outnormal;
std::vector< glm::vec2 > CMonster1::m_outuv;
GLint* CMonster1::m_Tri_Num2;
GLint CMonster1::m_Tri_Num = 1;


std::random_device rd1;
std::default_random_engine dre1{ rd1() };
std::uniform_int_distribution<> uid_dir1(1, 4);
...
void CMonster1::Init(glm::vec3 scaleInfo, glm::vec3 color, glm::vec3 pivot, const char* filename, stbi_uc* textData, stbi_uc* textData2,
	int text_monster_width, int text_monster_height, int textRed_height_width, int textRed_height_height)
{
	...
	InitTexture_1(m_Monster1_Text_data, text_monster_width, text_monster_height);
	InitBuffer();

}

glm::vec3 CMonster1::GetCollide_Position(int idx)
{
...
void CMonster1::Input(float fDeltaTime)
{
}

int CMonster1::Update(float fDeltaTime)
{
...
int CMonster1::LateUpdate(float fDeltaTime)
{
	return 0;
}

void CMonster1::Collision(float fDeltaTime)
{
}

void CMonster1::Render(float fDeltaTime)
{
...
void CMonster1::InitTexture_1(stbi_uc* textData, int text_moster_width, int text_moster_height)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, text_moster_width, text_moster_height, 0, GL_RGB, GL_UNSIGNED_BYTE, m_Monster1_Text_data);
...
int CMonster1::loadObj_normalize_center(const char* filename)
{
	FILE* objFile = NULL;
	static int i = 0;
	cout << i++ << endl;
