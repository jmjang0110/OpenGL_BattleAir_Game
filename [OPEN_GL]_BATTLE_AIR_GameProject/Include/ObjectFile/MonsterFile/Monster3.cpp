...
std::vector< glm::vec3 > CMonster3::m_outvertex;
std::vector< glm::vec3 > CMonster3::m_outnormal;
std::vector< glm::vec2 > CMonster3::m_outuv;
GLint* CMonster3::m_Tri_Num2;
GLint CMonster3::m_Tri_Num = 1;


std::random_device rd3;
std::default_random_engine dre3{ rd3() };
std::uniform_int_distribution<> uid_dir3(1, 4);
...
void CMonster3::Init(glm::vec3 scaleInfo, glm::vec3 color, glm::vec3 pivot, const char* filename, stbi_uc* textData, stbi_uc* textData2,
...
glm::vec3 CMonster3::GetCollide_Position(int idx)
{
...
void CMonster3::Input(float fDeltaTime)
{
}
...
int CMonster3::LateUpdate(float fDeltaTime)
{
	return 0;
}

void CMonster3::Collision(float fDeltaTime)
{
}

void CMonster3::Render(float fDeltaTime)
{
...
void CMonster3::InitTexture_1(stbi_uc* textData, int text_moster_width, int text_moster_height)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, text_moster_width, text_moster_height, 0, GL_RGB, GL_UNSIGNED_BYTE, m_Monster3_Text_data);
...
int CMonster3::loadObj_normalize_center(const char* filename)
{
	FILE* objFile = NULL;
	static int i = 0;
	cout << i++ << endl;
