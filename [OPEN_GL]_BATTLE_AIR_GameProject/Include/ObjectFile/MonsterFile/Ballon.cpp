...
std::vector< glm::vec3 > CAirballon::m_outnormal;
std::vector< glm::vec2 > CAirballon::m_outuv;
GLint* CAirballon::m_Tri_Num2;
GLint CAirballon::m_Tri_Num = 1;


CAirballon::CAirballon()
{
}
...
void CAirballon::Input(float fDeltaTime)
{
}
...
int CAirballon::LateUpdate(float fDeltaTime)
{
	return 0;
}

void CAirballon::Collision(float fDeltaTime)
{
}
...
void CAirballon::InitTexture_1(stbi_uc* textData, int text_moster_width, int text_moster_height)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, text_moster_width, text_moster_height, 0, GL_RGB, GL_UNSIGNED_BYTE, m_airballon_Text_data);
...
int CAirballon::loadObj_normalize_center(const char* filename)
{
	FILE* objFile = NULL;
	static int i = 0;
	cout << i++ << endl;
