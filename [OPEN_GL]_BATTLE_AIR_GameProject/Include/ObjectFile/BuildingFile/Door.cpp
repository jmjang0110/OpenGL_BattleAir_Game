...
std::vector< glm::vec3 > CDoor::m_outvertex;
std::vector< glm::vec3 > CDoor::m_outnormal;
std::vector< glm::vec2 > CDoor::m_outuv;
GLint* CDoor::m_Tri_Num2;
GLint CDoor::m_Tri_Num = 1;
...
void CDoor::Update_TranslateForm(glm::vec3 translate)
{
...
void CDoor::Update_RotateForm(GLfloat Time, GLfloat Axis_x, GLfloat Axis_y, GLfloat Axis_z)
{
...
void CDoor::Update_ScaleForm(GLfloat sx, GLfloat sy, GLfloat sz)
{
...
void CDoor::Update_ModelTransform(float fDeltaTime)
{
...
glm::vec3 CDoor::GetCollide_Position(int idx)
{
...
void CDoor::Init(glm::vec3 scaleInfo, glm::vec3 color, glm::vec3 pivot, const char* filename, stbi_uc* textData, stbi_uc* textData2,
	int text_building_width, int text_building_height, int textRed_height_width, int textRed_height_height)
{
	m_Door_Text_data = textData;
	...
	InitTexture_1(m_Door_Text_data, text_building_width, text_building_height);
	InitBuffer();
...
int CDoor::Update(float fDeltaTime)
{
...
int CDoor::LateUpdate(float fDeltaTime)
{
	return 0;
}
...
void CDoor::InitTexture_1(stbi_uc* textData, int text_building_width, int text_building_height)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, text_building_width, text_building_height, 0, GL_RGB, GL_UNSIGNED_BYTE, m_Door_Text_data);
...
int CDoor::loadObj_normalize_center(const char* filename)
{
	FILE* objFile = NULL;
	static int i = 0;
	cout << i++ << endl;
