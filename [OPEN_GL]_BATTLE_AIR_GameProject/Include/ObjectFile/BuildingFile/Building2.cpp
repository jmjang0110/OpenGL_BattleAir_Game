...
std::vector< glm::vec2 > CBuilding2::m_outuv;
GLint* CBuilding2::m_Tri_Num2;
GLint CBuilding2::m_Tri_Num = 1;
...
void CBuilding2::Update_TranslateForm(glm::vec3 translate)
{
...
void CBuilding2::Update_RotateForm(GLfloat Time, GLfloat Axis_x, GLfloat Axis_y, GLfloat Axis_z)
{
...
void CBuilding2::Update_ScaleForm(GLfloat sx, GLfloat sy, GLfloat sz)
{
...
void CBuilding2::Update_ModelTransform(float fDeltaTime)
{
...
void CBuilding2::Input(float fDeltaTime)
{
}

int CBuilding2::Update(float fDeltaTime)
{
...
int CBuilding2::LateUpdate(float fDeltaTime)
{
	return 0;
}

void CBuilding2::Collision(float fDeltaTime)
{
}

void CBuilding2::Render(float fDeltaTime)
{
...
int CBuilding2::loadObj_normalize_center(const char* filename)
{
	FILE* objFile = NULL;
	static int i = 0;
	cout << i++ << endl;
