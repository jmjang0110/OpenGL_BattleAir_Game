...
void CBuilding1::Init(glm::vec3 scaleInfo, glm::vec3 color, glm::vec3 pivot, const char* filename)
{
...
void CBuilding1::InitTexture_1()
{
	...
	stbi_uc* data = NULL;
	const char* filename = "./ObjectFile/BuildingFile/Brown.jpg";
