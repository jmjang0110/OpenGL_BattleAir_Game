...
void CBuilding3::Init(glm::vec3 scaleInfo, glm::vec3 color, glm::vec3 pivot, const char* filename)
{
...
void CBuilding3::InitTexture_1()
{
	...
	stbi_uc* data = NULL;
	const char* filename = "./ObjectFile/BuildingFile/top.jpg";
