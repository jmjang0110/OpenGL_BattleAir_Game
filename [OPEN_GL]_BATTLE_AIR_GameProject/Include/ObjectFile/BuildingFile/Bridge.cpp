...
std::vector< glm::vec3 > CBridge::m_outvertex;
std::vector< glm::vec3 > CBridge::m_outnormal;
std::vector< glm::vec2 > CBridge::m_outuv;
GLint* CBridge::m_Tri_Num2;
GLint CBridge::m_Tri_Num = 1;
...
void CBridge::Update_TranslateForm(glm::vec3 translate)
{
...
void CBridge::Update_RotateForm(GLfloat Time, GLfloat Axis_x, GLfloat Axis_y, GLfloat Axis_z)
{
...
void CBridge::Update_ScaleForm(GLfloat sx, GLfloat sy, GLfloat sz)
{
...
void CBridge::Update_ModelTransform(float fDeltaTime)
{
...
glm::vec3 CBridge::GetCollide_Position(int idx)
{
...
void CBridge::Init(glm::vec3 scaleInfo, glm::vec3 color, glm::vec3 pivot, const char* filename, stbi_uc* textData, stbi_uc* textData2,
	int text_building_width, int text_building_height, int textRed_height_width, int textRed_height_height)
{
	m_Bridge_Text_data = textData;
	...
	Update_RotateForm(-90.0f, 0.0f, 1.0f, 0.0f);
	...
	InitTexture_1(m_Bridge_Text_data, text_building_width, text_building_height);
	InitBuffer();

}

void CBridge::Input(float fDeltaTime)
{
}

int CBridge::Update(float fDeltaTime)
{
...
int CBridge::LateUpdate(float fDeltaTime)
{
	return 0;
}

void CBridge::Collision(float fDeltaTime)
{
}

void CBridge::Render(float fDeltaTime)
{
...
void CBridge::InitTexture_1(stbi_uc* textData, int text_building_width, int text_building_height)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, text_building_width, text_building_height, 0, GL_RGB, GL_UNSIGNED_BYTE, m_Bridge_Text_data);
...
int CBridge::loadObj_normalize_center(const char* filename)
{
	FILE* objFile = NULL;
	static int i = 0;
	cout << i++ << endl;
